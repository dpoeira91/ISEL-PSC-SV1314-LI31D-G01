...
void dlist_insertHead(struct dlist_node * head,
	...
	dlist_insertAfter(head, node);
}

void dlist_insertBefore(struct dlist_node * head,
                      struct dlist_node * node) {
	dlist_insertAfter(head -> prev , node);
}

void dlist_insertTail(struct dlist_node * head,
                      struct dlist_node * node) {
	dlist_insertBefore(head, node);
}*/
